...
/**
 * TrueMindPath - Shared Test Configuration
 * ------------------------------------------------------------------
 * Single source of truth for every test type (aptitude, personality, ...).
 * TestInstructions / AssessmentRunner / SectionSummary are all generic —
 * they read a `testType` route param and pull everything else from here.
 *
 * To add a new test in future: add one entry to TEST_CONFIGS. No component
 * code needs to change.
 * ------------------------------------------------------------------
 */

// 5-point agreement scale reused by every personality statement.
...
// Turns a list of plain statement strings into {prompt, options} question
// objects using the shared Likert scale.
const likertQuestions = (statements) =>
  statements.map((prompt) => ({ prompt, options: LIKERT_OPTIONS }));
...
// Turns [{ prompt, category }] into {prompt, category, options} question
// objects using the shared interest scale.
...
// Turns [{ prompt, category }] into {prompt, category, options} question
// objects using the shared Study Habits scale. `category` is kept as data
// for later grouping in the summary page.
...
export const TEST_CONFIGS = {
    ...
    sections: [
      {
        ...
        questions: [
          {
            prompt: "Add 32 + 63 + 67 + 47",
            options: ["308", "206", "209", "241"],
            answer: "209",
          },
          {
            prompt: "Subtract 874 - 187",
            options: ["653", "687", "587", "692"],
            answer: "687",
          },
          {
            prompt: "Multiply 537 × 4",
            options: ["2248", "2438", "3118", "2148"],
            answer: "2148",
          },
          {
            prompt: "Divide 2135 ÷ 7",
            options: ["305", "311", "287", "321"],
            answer: "305",
          },
          {
            prompt: "Calculate 3.86 × 18.47",
            options: ["72.3456", "70.1243", "76.3792", "71.2942"],
            answer: "71.2942",
          },
          {
          ...
          {
            prompt: "Add 7.43 + 8.99",
            options: ["15.88", "16.42", "16.05", "14.45"],
            answer: "16.42",
          },
          {
            prompt: "120% of 40 is:",
          ...
          {
            prompt: "Calculate 4 + 44 + 444 + 4.44",
            options: ["505.44", "450.04", "485.44", "496.44"],
            answer: "496.44",
          },
          {
            prompt: "666 ÷ 6 ÷ 3 = ?",
          ...
          {
            prompt: "Complete the series: 3, 4, 7, 8, 11, 12, ?",
            options: ["18", "15", "10", "21"],
            answer: "15",
          },
          {
            prompt: "Complete the series: 2, 6, 18, 54, ?",
            options: ["182", "199", "140", "162"],
            answer: "162",
          },
          {
            prompt: "Complete the series: 2, 4, 8, 14, 22, ?",
            options: ["31", "40", "32", "25"],
            answer: "32",
          },
          {
            prompt: "Find the odd one out.",
            options: ["422", "189", "144", "248"],
            answer: "189",
          },
          {
            prompt: "Find the odd one out.",
          ...
          {
            prompt: "(?) + 369 + 198 - 2047 = 3412",
            options: ["4015", "4751", "4892", "3548"],
            answer: "4892",
          },
          {
            prompt: "Choose the option that does not belong to the group.",
            options: ["137", "149", "157", "173"],
            answer: "149",
          },
          {
            prompt: "The sum of the first five prime numbers is:",
            options: ["12", "29", "31", "28"],
            answer: "28",
          },
          {
            prompt: "Calculate 4 + 33 + 333 + 3.33",
            options: ["182", "195", "100", "185"],
            answer: "195",
          },
        ],
      },
      {
        ...
        instructions: [
          "Covers vocabulary, analogies, sentence completion, idioms, proverbs, and language skills.",
          "Tests your command over language structure, reasoning, and word usage.",
        ...
        questions: [
          ...
          {
            prompt: "FAKE means:",
            options: ["Original", "Imitation", "Trustworthy", "Loyal"],
            answer: "Imitation",
          },
          {
            prompt: "ATTEMPT means:",
            options: ["Serve", "Explore", "Try", "Explain"],
            answer: "Try",
          },
          {
            prompt: "MINOR - Choose the antonym:",
            options: ["Big", "Major", "Tall", "Heavy"],
            answer: "Major",
          },
          {
            prompt: "PRELIMINARY - Choose the antonym:",
            options: ["Final", "First", "Secondary", "Initial"],
            answer: "Final",
          },
          {
            prompt: "ENCOURAGE - Choose the antonym:",
            options: ["Dampen", "Disapprove", "Discourage", "Warn"],
            answer: "Discourage",
          },
          {
            prompt:
              "She never visits any zoo because she is a strong opponent of the idea of ______.",
            options: [
          ...
          {
            prompt:
              "The officer who had neglected to file his income tax returns had to ______.",
            options: [
              "return the files",
              "pay a fine",
              "be rewarded",
          ...
          {
            prompt: "Better late than ______.",
            options: ["Today", "Sometime", "Never", "Ever"],
            answer: "Never",
          },
          {
            prompt: "The grass is always greener on the other ______.",
            options: ["East", "Part", "Side", "Coast"],
            answer: "Side",
          },
          {
            prompt: "Don't cry over spilled ______.",
            options: ["Broth", "Beans", "Honey", "Milk"],
            answer: "Milk",
          },
          {
          ...
          {
            prompt:
              "She exclaimed with sorrow that it was a very miserable plight.",
            options: [
...

      {
        ...
        questions: [
          {
            prompt: "Complete the series: ELFA, GLHA, ILJA, ____, MLNA",
            options: ["OLPA", "KLMA", "LLMA", "KLLA"],
            answer: "KLMA",
          },
          {
            prompt: "Complete the series: QAR, RAS, SAT, TAU, ____",
            options: ["UAV", "VAT", "TWA", "TBR"],
            answer: "UAV",
          },
          {
            prompt: "Complete the series: JAK, KBL, LCM, MDN, ____",
            options: ["REP", "NEO", "ENG", "SPW"],
            answer: "NEO",
          },
          {
            prompt: "Complete the series: CMM, EOO, GQQ, ____, KUU",
            options: ["IRR", "HSS", "ISS", "GTT"],
            answer: "ISS",
          },
          {
            prompt: "Complete the series: C-45, D-40, E-35, ____, G-25",
            options: ["F-21", "H-30", "F-30", "G-30"],
            answer: "F-30",
          },
          {
            prompt:
              "Sanya is older than Sahil. Soham is older than Sanya. Sahil is older than Soham. If the first two statements are true, the third statement is:",
            options: ["True", "False", "Uncertain"],
            answer: "False",
          },
          {
            prompt:
              "Blackberries cost more than strawberries. Blackberries cost less than raspberries. Raspberries cost more than strawberries and blackberries. If the first two statements are true, the third statement is:",
            options: ["True", "False", "Uncertain"],
            answer: "True",
          },
          {
            prompt:
              "During the past year, Anil saw more movies than Mohan. Mohan saw fewer movies than Dinesh. Dinesh saw more movies than Anil. If the first two statements are true, the third statement is:",
            options: ["True", "False", "Uncertain"],
            answer: "Uncertain",
          },
          {
            prompt:
              "If LEAK → MHYF and RAFT → SDDO, how will FIFE be coded?",
            options: ["GLDZ", "HLDV", "GLZD", "IFFE"],
            answer: "GLDZ",
          },
          {
            prompt:
              "If CONSULT is written as FOQRVWX, how will MAGNETS be written?",
            options: ["FROWQVX", "DHROPWV", "DHJPQVW", "LCUTESR"],
            answer: "DHJPQVW",
          },
          {
            prompt: "Find the odd one out.",
            options: ["Leaf", "Oxygen", "Stem", "Flower"],
            answer: "Oxygen",
          },
          {
            prompt: "Find the odd one out.",
            options: ["District", "State", "City", "Road"],
            answer: "Road",
          },
          {
            prompt: "Find the odd one out.",
            options: ["Bucket", "Door", "Room", "Window"],
            answer: "Bucket",
          },
          {
            prompt: "Find the odd one out.",
            options: ["Index", "Mark", "Chapters", "Preface"],
            answer: "Mark",
          },
          {
            prompt: "PETAL : FLOWER",
          ...
          },
          {
            ...
            options: ["Triangle", "Circle", "Oval", "Sphere"],
            answer: "Triangle",
          },
          {
            prompt: "Which word does NOT belong with the others?",
            options: ["Biology", "Chemistry", "Theology", "Zoology"],
            answer: "Theology",
          },
          {
            prompt: "Which word does NOT belong with the others?",
            options: ["Area", "Variable", "Circumference", "Quadrilateral"],
            answer: "Variable",
          },
        ],
      },
      {
        ...
        description:
          "The Rapid Assessment section measures a candidate's ability to process information quickly, make accurate decisions under time pressure, and maintain concentration. It measures mental speed and efficiency rather than deep analytical reasoning.",
        totalQuestions: 65,
        instructions: [
          "Read each question carefully before selecting your answer.",
          "Work as quickly as possible while maintaining accuracy.",
          "Choose the most appropriate answer for every question.",
          ...
          "You cannot pause the assessment once it has started.",
        ],
        groups: [
          {
            id: "find-larger",
      ...
      },
      {
        ...
        questions: [
          {
            type: "spatial",
            prompt: "Choose the alternative which closely resembles the water-image of the given combination.",
            questionImage: "/images/spatial/q1.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },

          {
            type: "spatial",
            prompt: "Choose the alternative which closely resembles the water-image of the given combination.",
            questionImage: "/images/spatial/q2.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },
          ...
          {
            type: "spatial",
            prompt: "Choose the alternative which closely resembles the mirror image of the given combination.",
            questionImage: "/images/spatial/q3.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "spatial",
            prompt: "Choose the alternative which closely resembles the mirror image of the given combination.",
            questionImage: "/images/spatial/q4.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
          ...
          {
            type: "spatial",
            prompt: "Find out from amongst the four alternatives as to how the pattern would appear when the transparent sheet is folded at the dotted line.",
            questionImage: "/images/spatial/q5.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "spatial",
            prompt: "Find out from amongst the four alternatives as to how the pattern would appear when the transparent sheet is folded at the dotted line.",
            questionImage: "/images/spatial/q6.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "spatial",
            prompt: "Find out from amongst the four alternatives as to how the pattern would appear when the transparent sheet is folded at the dotted line.",
            questionImage: "/images/spatial/q7.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
          ...
          {
            type: "spatial",
            prompt: "Select a figure from the given four alternatives which fits exactly into Figure-X to form a complete square.",
            questionImage: "/images/spatial/q8.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "spatial",
            prompt: "Select a figure from the given four alternatives which fits exactly into Figure-X to form a complete square.",
            questionImage: "/images/spatial/q9.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "spatial",
            prompt: "Select a figure from the given four alternatives which fits exactly into Figure-X to form a complete square.",
            questionImage: "/images/spatial/q10.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
          ...
          {
            type: "spatial",
            prompt: "Choose a figure which would most closely resemble the unfolded form of Figure (Z).",
            questionImage: "/images/spatial/q11.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "spatial",
            prompt: "Choose a figure which would most closely resemble the unfolded form of Figure (Z).",
            questionImage: "/images/spatial/q12.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },

          {
            type: "spatial",
            prompt: "Choose a figure which would most closely resemble the unfolded form of Figure (Z).",
            questionImage: "/images/spatial/q13.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },
          ...
          {
            type: "spatial",
            prompt: "Find out the figure which contains figure (X) as its part.",
            questionImage: "/images/spatial/q14.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "spatial",
            prompt: "Find out the figure which contains figure (X) as its part.",
            questionImage: "/images/spatial/q15.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
        ],
      },
      {
        ...
        difficulty: "Adaptive",
        instructions: [
          "Observe each figure carefully before selecting your answer.",
          "Most questions require identifying patterns, sequences, matrices, or embedded figures.",
          "All answer figures are provided inside the question image.",
          "Select the corresponding option number (1–4 or 1–5) as your answer.",
          "Each question carries equal weight; there is no negative marking.",
        ...
        questions: [
          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q1.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q2.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q3.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q4.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q5.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q6.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },

          {
            type: "mental-agility",
            prompt: "Identify the figure that completes the pattern.",
            questionImage: "/images/mental-agility/q7.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },
          ...
          {
            type: "mental-agility",
            prompt: "Select a figure from amongst the Answer Figures which will continue the same series as established by the five Problem Figures.",
            questionImage: "/images/mental-agility/q8.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 4, // E
          },

          {
            type: "mental-agility",
            prompt: "Select a figure from amongst the Answer Figures which will continue the same series as established by the five Problem Figures.",
            questionImage: "/images/mental-agility/q9.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 3, // D
          },

          {
            type: "mental-agility",
            prompt: "Select a figure from amongst the Answer Figures which will continue the same series as established by the five Problem Figures.",
            questionImage: "/images/mental-agility/q10.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 3, // D
          },

          {
            type: "mental-agility",
            prompt: "Select a figure from amongst the Answer Figures which will continue the same series as established by the five Problem Figures.",
            questionImage: "/images/mental-agility/q11.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 2, // C
          },
          ...
          {
            type: "mental-agility",
            prompt: "Find out which of the figures (1), (2), (3) and (4) can be formed from the pieces given in figure (X).",
            questionImage: "/images/mental-agility/q12.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "mental-agility",
            prompt: "Find out which of the figures (1), (2), (3) and (4) can be formed from the pieces given in figure (X).",
            questionImage: "/images/mental-agility/q13.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Find out which of the figures (1), (2), (3) and (4) can be formed from the pieces given in figure (X).",
            questionImage: "/images/mental-agility/q14.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Find out which of the figures (1), (2), (3) and (4) can be formed from the pieces given in figure (X).",
            questionImage: "/images/mental-agility/q15.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "mental-agility",
            prompt: "Find out which of the figures (1), (2), (3) and (4) can be formed from the pieces given in figure (X).",
            questionImage: "/images/mental-agility/q16.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },
          ...
          {
            type: "mental-agility",
            prompt: "Find out the alternative figure which contains figure (X) as its part.",
            questionImage: "/images/mental-agility/q17.png",
            options: ["1", "2", "3", "4"],
            answer: 0, // A
          },

          {
            type: "mental-agility",
            prompt: "Find out the alternative figure which contains figure (X) as its part.",
            questionImage: "/images/mental-agility/q18.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Find out the alternative figure which contains figure (X) as its part.",
            questionImage: "/images/mental-agility/q19.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
          ...
          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q20.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q21.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q22.png",
            options: ["1", "2", "3", "4"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q23.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q24.png",
            options: ["1", "2", "3", "4"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the four alternatives that would complete the figure matrix.",
            questionImage: "/images/mental-agility/q25.png",
            options: ["1", "2", "3", "4"],
            answer: 3, // D
          },
          ...
          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q26.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q27.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q28.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 1, // B
          },

          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q29.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q30.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Choose the figure which is different from the rest.",
            questionImage: "/images/mental-agility/q31.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 3, // D
          },
          ...
          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the Answer Figures that would replace the question mark (?).",
            questionImage: "/images/mental-agility/q32.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 0, // A
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the Answer Figures that would replace the question mark (?).",
            questionImage: "/images/mental-agility/q33.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 4, // E
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the Answer Figures that would replace the question mark (?).",
            questionImage: "/images/mental-agility/q34.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 2, // C
          },

          {
            type: "mental-agility",
            prompt: "Select a suitable figure from the Answer Figures that would replace the question mark (?).",
            questionImage: "/images/mental-agility/q35.png",
            options: ["1", "2", "3", "4", "5"],
            answer: 3, // D
          },
        ],
  ...
  // ------------------------------------------------------------------
  // PERSONALITY  (Big Five / OCEAN model, 5-point Likert agreement scale)
  // ------------------------------------------------------------------
  // personality: {
  //   label: "Personality Questionnaire",
  //   landingPath: "/test/personality",
  //   sections: [
  //     {
  //       id: "openness",
  //       title: "Openness to Experience",
  //       subtitle: "Curiosity, Imagination & Creativity",
  //       icon: Sparkles,
  //       timeLimit: "08:00",
  //       timeLimitSeconds: 8 * 60,
  //       difficulty: "Self-paced",
  //       instructions: [
  //         "Covers curiosity, imagination, and openness to new ideas and experiences.",
  //         "There are no right or wrong answers — respond with your honest first instinct.",
  //         "Rate how much you agree with each statement using the 5-point scale.",
  //         "Every statement carries equal weight; there is no negative marking.",
  //         "The timer counts down continuously — it cannot be paused once started.",
  //         "Your answers are auto-saved as you navigate between statements.",
  //       ],
  //       questions: likertQuestions([
  //         "I enjoy exploring new ideas, even if they challenge what I already believe.",
  //         "I have a vivid imagination and often daydream about possibilities.",
  //         "I appreciate art, music, or writing that is unconventional.",
  //         "I get excited about learning things outside my usual field.",
  //         "I prefer variety and novelty over routine.",
  //         "I often come up with original or creative solutions to problems.",
  //         "I like discussing abstract or theoretical ideas.",
  //         "I'm drawn to travel or experiences that expose me to different cultures.",
  //       ]),
  //     },
  //     {
  //       id: "conscientiousness",
  //       title: "Conscientiousness",
  //       subtitle: "Organization, Discipline & Reliability",
  //       icon: ListChecks,
  //       timeLimit: "08:00",
  //       timeLimitSeconds: 8 * 60,
  //       difficulty: "Self-paced",
  //       instructions: [
  //         "Covers organization, self-discipline, and dependability in daily life and work.",
  //         "There are no right or wrong answers — respond with your honest first instinct.",
  //         "Rate how much you agree with each statement using the 5-point scale.",
  //         "Every statement carries equal weight; there is no negative marking.",
  //         "The timer counts down continuously — it cannot be paused once started.",
  ...
  //       ],
  //       questions: likertQuestions([
  //         "I like to keep my workspace and schedule well organized.",
  //         "I follow through on commitments, even when they become inconvenient.",
  //         "I plan ahead rather than acting on impulse.",
  //         "I pay close attention to detail in my work.",
  //         "I set clear goals and work steadily toward them.",
  //         "I finish tasks before moving on to something else.",
  //         "I hold myself to high standards.",
  //         "I prefer structure and clear expectations over ambiguity.",
  //       ]),
  //     },
  //     {
  //       id: "extraversion",
  //       title: "Extraversion",
  //       subtitle: "Sociability, Energy & Assertiveness",
  //       icon: Users,
  //       timeLimit: "08:00",
  //       timeLimitSeconds: 8 * 60,
  //       difficulty: "Self-paced",
  //       instructions: [
  //         "Covers sociability, energy levels, and comfort in social situations.",
  //         "There are no right or wrong answers — respond with your honest first instinct.",
  //         "Rate how much you agree with each statement using the 5-point scale.",
  //         "Every statement carries equal weight; there is no negative marking.",
  //         "The timer counts down continuously — it cannot be paused once started.",
  ...
  //         "I find it easy to start conversations with people I don't know.",
  //         "I enjoy being the center of attention in social settings.",
  //         "I speak up quickly in group discussions.",
  //         "I prefer active, busy environments over quiet ones.",
  //         "I make friends easily.",
  //         "I feel comfortable taking the lead in group activities.",
  //         "I would rather spend a free evening out with others than alone.",
  //       ]),
  //     },
  //     {
  //       id: "agreeableness",
  //       title: "Agreeableness",
  //       subtitle: "Empathy, Cooperation & Trust",
  //       icon: HeartHandshake,
  //       timeLimit: "08:00",
  //       timeLimitSeconds: 8 * 60,
  //       difficulty: "Self-paced",
  //       instructions: [
  //         "Covers empathy, cooperation, and how you relate to and trust others.",
  //         "There are no right or wrong answers — respond with your honest first instinct.",
  //         "Rate how much you agree with each statement using the 5-point scale.",
  //         "Every statement carries equal weight; there is no negative marking.",
  //         "The timer counts down continuously — it cannot be paused once started.",
  ...
  //       ],
  //       questions: likertQuestions([
  //         "I try to see things from other people's perspectives before judging them.",
  //         "I go out of my way to help colleagues or friends in need.",
  //         "I find it easy to trust people I've just met.",
  //         "I avoid conflict and try to keep the peace in group settings.",
  //         "I genuinely care about how my decisions affect others.",
  //         "I give people the benefit of the doubt.",
  //         "I enjoy collaborating more than competing.",
  //         "I'm quick to forgive when someone makes a mistake.",
  //       ]),
  //     },
  //     {
  //       id: "emotional-stability",
  //       title: "Emotional Stability",
  //       subtitle: "Resilience, Calmness & Stress Management",
  //       icon: ShieldCheck,
  //       timeLimit: "08:00",
  //       timeLimitSeconds: 8 * 60,
  //       difficulty: "Self-paced",
  //       instructions: [
  //         "Covers how you handle stress, pressure, and emotional ups and downs.",
  //         "There are no right or wrong answers — respond with your honest first instinct.",
  //         "Rate how much you agree with each statement using the 5-point scale.",
  //         "Every statement carries equal weight; there is no negative marking.",
  //         "The timer counts down continuously — it cannot be paused once started.",
  ...
  //       ],
  //       questions: likertQuestions([
  //         "I stay calm under pressure rather than getting flustered.",
  //         "I recover quickly after a setback or disappointment.",
  //         "I rarely feel overwhelmed by everyday stress.",
  //         "My mood stays fairly steady even when things don't go as planned.",
  //         "I can manage criticism without taking it too personally.",
  //         "I don't dwell on mistakes for very long.",
  //         "I feel in control of my emotions most of the time.",
  //         "I sleep and function well even during busy or stressful periods.",
  //       ]),
  //     },
  //   ],
  // },
  ...
  // ------------------------------------------------------------------
  // INTEREST INVENTORY (career interest areas, 5-point like/dislike scale)
  // ------------------------------------------------------------------
  interest: {
    label: "Career Interest",
    landingPath: "/test/interest",
    sections: [
      {
        ...
        instructions: [
          ...
          "If you are unsure of an answer, make your best choice and move on.",
          "There are no right or wrong answers — respond with your honest first instinct.",
          "Every question carries equal weight; there is no negative marking.",
          "The timer counts down continuously — it cannot be paused once started.",
          "Your answers are auto-saved as you navigate between questions.",
        ],
...
// ------------------------------------------------------------------
  // STUDY HABITS (planning, understanding, resilience, exam stress —
  // 4-point frequency scale). Rendered as one flat, single-page list
  // (reusing the same "single-page-interest" runner) so the underlying
  // category dimensions are never surfaced to the student as section
  // titles or tabs.
  // ------------------------------------------------------------------
  studyHabits: {
    label: "Study Habits",
    landingPath: "/test/studyHabits",
    sections: [
      {
        id: "study-habits-inventory",
...
// Convenience helpers used by AssessmentRunner / SectionSummary so they
// never need to know the internal shape of TEST_CONFIGS.
export const getTestConfig = (testType) => TEST_CONFIGS[testType] || TEST_CONFIGS.aptitude;

export const getSectionOrder = (testType) => getTestConfig(testType).sections.map((s) => s.id);

export const getSection = (testType, sectionId) => {
